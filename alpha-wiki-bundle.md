...
> 整個研究 wiki 的單檔匯出（共 48 頁），供 LLM 一次讀完、逐環節審閱。
...
<a name='local-operators'></a>
# 〔local-operators〕本地模型工人層：產候選觀察，永不產已知事實
...
<a name='graph-native'></a>
# 〔graph-native〕graph-native：讓圖與超圖成為思考器官，而非事後記帳
...
<a name='exp-008-world-alpha'></a>
# 〔exp-008-world-alpha〕實驗 008：世界模型 Alpha 第一輪——世界層訊號 dev 全過、validation 全崩
...
<a name='exp-009-expectation-layer'></a>
# 〔exp-009-expectation-layer〕實驗 009（預備）：預測市場預期層——E_t[event] 不是 W_t
...
<a name='blockers'></a>
# 〔blockers〕難點與卡關：這條線現在真正卡在哪（v2，B0 置頂）
