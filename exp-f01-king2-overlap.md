...
延伸：king2 精確規則與殘差四格見 [[champion-challenger|現任冠軍制度]]；主線改向前的通用線成果見 [[exp-009-expectation-layer|EXP-009]]（暫停擴張、成果保留）；資料契約狀態機見 [[blockers|難點 B1]]。**F02 已跑完**：低重疊法人軸對辨識 king2 錯誤**無樣本外增量**（雙 NO_INCREMENTAL_EVIDENCE）——「低相關≠增量」被實驗直接驗證，見 [[exp-f02-residual-discrimination]]。
